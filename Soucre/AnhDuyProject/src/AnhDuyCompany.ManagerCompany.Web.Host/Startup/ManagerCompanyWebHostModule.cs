...
using AnhDuyCompany.ManagerCompany.Web.Startup.ExternalLoginInfoProviders;
...
namespace AnhDuyCompany.ManagerCompany.Web.Startup
{
    ...
    public class ManagerCompanyWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ManagerCompanyWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ManagerCompanyWebHostModule).GetAssembly());
        }
