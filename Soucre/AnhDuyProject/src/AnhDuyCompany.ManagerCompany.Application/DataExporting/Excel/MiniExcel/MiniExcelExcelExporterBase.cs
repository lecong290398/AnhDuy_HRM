...
namespace AnhDuyCompany.ManagerCompany.DataExporting.Excel.MiniExcel
{
    public abstract class MiniExcelExcelExporterBase : ManagerCompanyServiceBase, ITransientDependency
    {
