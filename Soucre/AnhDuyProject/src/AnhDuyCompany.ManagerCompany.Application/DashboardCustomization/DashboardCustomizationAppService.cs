...
namespace AnhDuyCompany.ManagerCompany.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ManagerCompanyAppServiceBase, IDashboardCustomizationAppService
    {
