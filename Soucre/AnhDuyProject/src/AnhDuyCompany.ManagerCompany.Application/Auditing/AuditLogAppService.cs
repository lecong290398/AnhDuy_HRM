...
using AnhDuyCompany.ManagerCompany.Auditing.Exporting;
...
using EntityHistoryHelper = AnhDuyCompany.ManagerCompany.EntityHistory.EntityHistoryHelper;

namespace AnhDuyCompany.ManagerCompany.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ManagerCompanyAppServiceBase, IAuditLogAppService
    {
