...
using AnhDuyCompany.ManagerCompany.DynamicEntityPropertyValues.Dto;
...
namespace AnhDuyCompany.ManagerCompany.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : ManagerCompanyAppServiceBase, IDynamicEntityPropertyValueAppService
    {
