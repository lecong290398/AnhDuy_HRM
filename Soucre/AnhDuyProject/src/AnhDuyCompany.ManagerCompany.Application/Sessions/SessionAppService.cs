...
{
    public class SessionAppService : ManagerCompanyAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ManagerCompanyConsts.Currency,
                        CurrencySign = ManagerCompanyConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ManagerCompanyConsts.AllowTenantsToChangeEmailSettings,
