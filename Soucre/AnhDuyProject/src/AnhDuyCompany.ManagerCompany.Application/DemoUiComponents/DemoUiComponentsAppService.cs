...
using AnhDuyCompany.ManagerCompany.DemoUiComponents.Dto;

namespace AnhDuyCompany.ManagerCompany.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ManagerCompanyAppServiceBase, IDemoUiComponentsAppService
    {
