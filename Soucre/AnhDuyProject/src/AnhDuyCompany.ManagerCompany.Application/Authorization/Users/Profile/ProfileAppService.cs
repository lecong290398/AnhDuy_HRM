...
using AnhDuyCompany.ManagerCompany.Authorization.Users.Profile.Cache;
...
using AnhDuyCompany.ManagerCompany.Gdpr;
...
using AnhDuyCompany.ManagerCompany.Timing;

namespace AnhDuyCompany.ManagerCompany.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ManagerCompanyAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("AnhDuyCompany.ManagerCompany",
