...
namespace AnhDuyCompany.ManagerCompany.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : ManagerCompanyAppServiceBase, IUserDelegationAppService
    {
