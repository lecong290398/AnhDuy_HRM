...
using AnhDuyCompany.ManagerCompany.Tenants.Dashboard.Dto;

namespace AnhDuyCompany.ManagerCompany.Tenants.Dashboard
{
    public static class DashboardRandomDataGenerator
    {
        ...
        public static List<MemberActivity> GenerateMemberActivities()
        {
            ...
            {
                new MemberActivity("Brain", ManagerCompanyConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "015-boy-6.svg"),

                new MemberActivity("Jane", ManagerCompanyConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%","017-girl-8.svg"),

                new MemberActivity("Tim", ManagerCompanyConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "004-boy-1.svg"),

                new MemberActivity("Kate", ManagerCompanyConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
