...
using AnhDuyCompany.ManagerCompany.Migrations.Seed.Host;
...
namespace AnhDuyCompany.ManagerCompany.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ManagerCompanyAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ManagerCompanyDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ManagerCompanyConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ManagerCompanyConsts.ConnectionStringName}", constring);
        }
