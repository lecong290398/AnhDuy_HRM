...
#if ANDROID
using AnhDuyCompany.ManagerCompany.Mobile.MAUI.Platforms.Android.HttpClient;
#endif
...
#elif IOS
            var abpHttpClientFactory = new AnhDuyCompany.ManagerCompany.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
