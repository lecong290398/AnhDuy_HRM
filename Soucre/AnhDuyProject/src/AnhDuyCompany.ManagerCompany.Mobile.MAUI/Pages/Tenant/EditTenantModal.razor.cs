...
using AnhDuyCompany.ManagerCompany.Mobile.MAUI.Extensions;
using AnhDuyCompany.ManagerCompany.Mobile.MAUI.Models.Tenants;
...
namespace AnhDuyCompany.ManagerCompany.Mobile.MAUI.Pages.Tenant
{
