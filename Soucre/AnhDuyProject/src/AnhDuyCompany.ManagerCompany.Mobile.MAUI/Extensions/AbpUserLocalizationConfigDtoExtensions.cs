...
namespace AnhDuyCompany.ManagerCompany.Mobile.MAUI.Extensions
{
    public static class AbpUserLocalizationConfigDtoExtensions
    {
        ...
        {
            return Localize(userLocalizationConfig, key, ManagerCompanyConsts.LocalizationSourceName, args);
        }
    }
}
