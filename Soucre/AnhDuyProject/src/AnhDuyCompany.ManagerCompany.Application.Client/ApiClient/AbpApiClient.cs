...
using AnhDuyCompany.ManagerCompany.Extensions;

namespace AnhDuyCompany.ManagerCompany.ApiClient
{
    public class AbpApiClient : ISingletonDependency, IDisposable
    {
        ...
        private void AddHeaders(string accessToken)
        {
            ...
            _client.WithHeader("User-Agent", ManagerCompanyConsts.AbpApiClientUserAgent);
