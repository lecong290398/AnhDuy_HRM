...
using AnhDuyCompany.ManagerCompany.Authentication.TwoFactor;
...
using AnhDuyCompany.ManagerCompany.Web.Authentication.JwtBearer;
using AnhDuyCompany.ManagerCompany.Web.Authentication.TwoFactor;
using AnhDuyCompany.ManagerCompany.Web.Chat.SignalR;
using AnhDuyCompany.ManagerCompany.Web.Common;
using AnhDuyCompany.ManagerCompany.Web.Configuration;
...
namespace AnhDuyCompany.ManagerCompany.Web
{
    [DependsOn(
    ...
    public class ManagerCompanyWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ManagerCompanyWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ManagerCompanyApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ManagerCompanyWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ManagerCompanyWebCoreModule).Assembly);
        }
