...
using AnhDuyCompany.ManagerCompany.Web.Models.TokenAuth;
using AnhDuyCompany.ManagerCompany.Authorization.Impersonation;
...
using AnhDuyCompany.ManagerCompany.Net.Sms;
using AnhDuyCompany.ManagerCompany.Notifications;
using AnhDuyCompany.ManagerCompany.Security.Recaptcha;
using AnhDuyCompany.ManagerCompany.Web.Authentication.External;
...
namespace AnhDuyCompany.ManagerCompany.Web.Controllers
{
    ...
    public class TokenAuthController : ManagerCompanyControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(ManagerCompanyConsts.DateTimeOffsetFormat));
