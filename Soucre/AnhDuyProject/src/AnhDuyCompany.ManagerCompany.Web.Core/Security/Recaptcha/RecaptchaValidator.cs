...
namespace AnhDuyCompany.ManagerCompany.Web.Security.Recaptcha
{
    public class RecaptchaValidator : ManagerCompanyServiceBase, IRecaptchaValidator, ITransientDependency
    {
