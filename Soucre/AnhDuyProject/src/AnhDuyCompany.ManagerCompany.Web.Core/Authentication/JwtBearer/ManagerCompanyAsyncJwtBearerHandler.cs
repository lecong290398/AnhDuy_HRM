...
{
    public class ManagerCompanyAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public ManagerCompanyAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
