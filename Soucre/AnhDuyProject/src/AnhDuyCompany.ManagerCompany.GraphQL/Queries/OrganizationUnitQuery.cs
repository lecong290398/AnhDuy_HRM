...
using AnhDuyCompany.ManagerCompany.Core.Base;
using AnhDuyCompany.ManagerCompany.Core.Extensions;
using AnhDuyCompany.ManagerCompany.Dto;
using AnhDuyCompany.ManagerCompany.Types;

namespace AnhDuyCompany.ManagerCompany.Queries
{
    public class OrganizationUnitQuery : ManagerCompanyQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
