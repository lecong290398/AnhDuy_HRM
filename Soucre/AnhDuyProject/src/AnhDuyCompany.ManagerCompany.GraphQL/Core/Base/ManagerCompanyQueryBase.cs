...
namespace AnhDuyCompany.ManagerCompany.Core.Base
{
    public abstract class ManagerCompanyQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ManagerCompanyQueryBase(string fieldName,
