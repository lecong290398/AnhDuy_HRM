...
using AnhDuyCompany.ManagerCompany.Web.Models.Account;
...
using AnhDuyCompany.ManagerCompany.Web.Security.Recaptcha;
using AnhDuyCompany.ManagerCompany.Web.Session;
using AnhDuyCompany.ManagerCompany.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : ManagerCompanyControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(ManagerCompanyConsts.DateTimeOffsetFormat));
