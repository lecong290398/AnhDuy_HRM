...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Views.Shared.Themes.Theme5.Components.AppAreaNameTheme5Brand
{
    public class AppAreaNameTheme5BrandViewComponent : ManagerCompanyViewComponent
    {
