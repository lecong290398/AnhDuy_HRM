...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameLanguageSwitch
{
    public class AppAreaNameLanguageSwitchViewComponent : ManagerCompanyViewComponent
    {
