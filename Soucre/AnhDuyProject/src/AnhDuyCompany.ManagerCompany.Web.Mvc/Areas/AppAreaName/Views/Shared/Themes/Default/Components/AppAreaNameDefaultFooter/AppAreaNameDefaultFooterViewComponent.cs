...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Views.Shared.Themes.Default.Components.AppAreaNameDefaultFooter
{
    public class AppAreaNameDefaultFooterViewComponent : ManagerCompanyViewComponent
    {
