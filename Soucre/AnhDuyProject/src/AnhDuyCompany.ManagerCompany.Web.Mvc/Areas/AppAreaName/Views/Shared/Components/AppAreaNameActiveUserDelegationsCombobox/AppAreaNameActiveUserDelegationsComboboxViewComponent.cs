...
using AnhDuyCompany.ManagerCompany.Authorization.Users.Delegation;
...
{
    public class AppAreaNameActiveUserDelegationsComboboxViewComponent : ManagerCompanyViewComponent
    {
