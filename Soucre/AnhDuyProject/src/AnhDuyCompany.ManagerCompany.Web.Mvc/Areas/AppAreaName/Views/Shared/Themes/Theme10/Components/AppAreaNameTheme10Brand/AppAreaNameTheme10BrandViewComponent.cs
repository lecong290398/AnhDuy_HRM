...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Views.Shared.Themes.Theme10.Components.AppAreaNameTheme10Brand
{
    public class AppAreaNameTheme10BrandViewComponent : ManagerCompanyViewComponent
    {
