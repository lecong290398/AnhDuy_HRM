...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameUserMenu
{
    public class AppAreaNameUserMenuViewComponent : ManagerCompanyViewComponent
    {
