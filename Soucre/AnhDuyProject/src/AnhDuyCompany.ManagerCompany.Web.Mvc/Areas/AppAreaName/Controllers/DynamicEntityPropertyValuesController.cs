...
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.DynamicEntityPropertyValues;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : ManagerCompanyControllerBase
    {
