...
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.Roles;
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.Users;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class UsersController : ManagerCompanyControllerBase
    {
