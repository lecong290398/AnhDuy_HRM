...
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.Languages;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : ManagerCompanyControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = ManagerCompanyConsts.LocalizationSourceName;
            }
