...
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.DynamicEntityProperty;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    ...
    public class DynamicEntityPropertyController : ManagerCompanyControllerBase
    {
