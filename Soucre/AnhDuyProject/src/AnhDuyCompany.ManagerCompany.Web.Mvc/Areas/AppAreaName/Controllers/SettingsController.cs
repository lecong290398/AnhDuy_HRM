...
using AnhDuyCompany.ManagerCompany.Configuration.Tenants;
...
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.Settings;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    ...
    public class SettingsController : ManagerCompanyControllerBase
    {
