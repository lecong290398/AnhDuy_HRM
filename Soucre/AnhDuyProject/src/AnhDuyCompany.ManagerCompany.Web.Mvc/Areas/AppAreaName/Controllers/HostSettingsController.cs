...
using AnhDuyCompany.ManagerCompany.Configuration.Host;
using AnhDuyCompany.ManagerCompany.Editions;
using AnhDuyCompany.ManagerCompany.Timing;
using AnhDuyCompany.ManagerCompany.Timing.Dto;
using AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace AnhDuyCompany.ManagerCompany.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : ManagerCompanyControllerBase
    {
