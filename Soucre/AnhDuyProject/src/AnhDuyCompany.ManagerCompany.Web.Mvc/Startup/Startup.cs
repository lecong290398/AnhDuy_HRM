...
using AnhDuyCompany.ManagerCompany.Schemas;
using AnhDuyCompany.ManagerCompany.Web.Chat.SignalR;
using AnhDuyCompany.ManagerCompany.Web.Common;
using AnhDuyCompany.ManagerCompany.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using AnhDuyCompany.ManagerCompany.Web.Swagger;
using Stripe;
...
using AnhDuyCompany.ManagerCompany.Web.Extensions;
using AnhDuyCompany.ManagerCompany.Web.MultiTenancy;
using SecurityStampValidatorCallback = AnhDuyCompany.ManagerCompany.Identity.SecurityStampValidatorCallback;
...
namespace AnhDuyCompany.ManagerCompany.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<ManagerCompanyWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseManagerCompanyForwardedHeaders();
            }
            else
            {
            ...
            if (ManagerCompanyConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ManagerCompany API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("AnhDuyCompany.ManagerCompany.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "ManagerCompany API", Version = "v1"});
                ...
                var applicationXml = $"AnhDuyCompany.ManagerCompany.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"AnhDuyCompany.ManagerCompany.Web.Core.xml";
