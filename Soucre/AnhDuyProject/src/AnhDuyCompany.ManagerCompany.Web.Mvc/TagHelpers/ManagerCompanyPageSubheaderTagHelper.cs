...
using AnhDuyCompany.ManagerCompany.UiCustomization.Dto;

namespace AnhDuyCompany.ManagerCompany.Web.TagHelpers
{
    ...
    public class ManagerCompanyPageSubheaderTagHelper : TagHelper
    {
        ...
        public ManagerCompanyPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
