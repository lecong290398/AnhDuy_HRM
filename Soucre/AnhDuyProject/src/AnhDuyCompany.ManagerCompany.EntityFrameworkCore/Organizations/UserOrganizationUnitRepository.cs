...
{
    public class UserOrganizationUnitRepository : ManagerCompanyRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<ManagerCompanyDbContext> dbContextProvider)
