...
{
    public class SubscriptionPaymentRepository : ManagerCompanyRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ManagerCompanyDbContext> dbContextProvider)
