...
{
    public class SubscriptionPaymentExtensionDataRepository : ManagerCompanyRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ManagerCompanyDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
