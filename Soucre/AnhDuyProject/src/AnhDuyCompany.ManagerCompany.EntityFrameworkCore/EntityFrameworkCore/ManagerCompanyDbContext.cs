...
{
    public class ManagerCompanyDbContext : AbpZeroDbContext<Tenant, Role, User, ManagerCompanyDbContext>
    {
        ...
        public ManagerCompanyDbContext(DbContextOptions<ManagerCompanyDbContext> options)
            : base(options)
        {
