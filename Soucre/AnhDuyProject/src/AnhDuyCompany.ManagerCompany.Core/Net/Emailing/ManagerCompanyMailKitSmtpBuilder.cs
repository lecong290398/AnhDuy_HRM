...
{
    public class ManagerCompanyMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public ManagerCompanyMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(ManagerCompanyConsts.LocalizationSourceName, name);
        }
    }
}