...
{
    public class StripeGatewayManager : ManagerCompanyServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ManagerCompany";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ManagerCompanyConsts.Currency;
        }
