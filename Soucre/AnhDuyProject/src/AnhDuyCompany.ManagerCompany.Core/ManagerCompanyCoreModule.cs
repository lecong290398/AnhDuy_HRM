...
using AnhDuyCompany.ManagerCompany.Authorization.Ldap;
...
using AnhDuyCompany.ManagerCompany.DashboardCustomization.Definitions;
using AnhDuyCompany.ManagerCompany.Debugging;
using AnhDuyCompany.ManagerCompany.DynamicEntityProperties;
using AnhDuyCompany.ManagerCompany.Features;
using AnhDuyCompany.ManagerCompany.Friendships;
using AnhDuyCompany.ManagerCompany.Friendships.Cache;
using AnhDuyCompany.ManagerCompany.Localization;
using AnhDuyCompany.ManagerCompany.MultiTenancy;
using AnhDuyCompany.ManagerCompany.Net.Emailing;
using AnhDuyCompany.ManagerCompany.Notifications;
using AnhDuyCompany.ManagerCompany.WebHooks;
using Newtonsoft.Json;

namespace AnhDuyCompany.ManagerCompany
{
    [DependsOn(
        typeof(ManagerCompanyCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ManagerCompanyCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ManagerCompanyLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ManagerCompanyConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ManagerCompanyMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ManagerCompanySmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ManagerCompanyCoreModule).GetAssembly());
        }
