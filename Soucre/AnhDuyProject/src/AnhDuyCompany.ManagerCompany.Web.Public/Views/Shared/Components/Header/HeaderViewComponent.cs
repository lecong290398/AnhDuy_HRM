...
using AnhDuyCompany.ManagerCompany.Web.Public.Startup;
using AnhDuyCompany.ManagerCompany.Web.Session;
using AnhDuyCompany.ManagerCompany.Web.UiCustomization;

namespace AnhDuyCompany.ManagerCompany.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ManagerCompanyViewComponent
    {
