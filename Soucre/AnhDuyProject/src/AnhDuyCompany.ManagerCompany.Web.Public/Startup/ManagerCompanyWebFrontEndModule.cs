...
namespace AnhDuyCompany.ManagerCompany.Web.Public.Startup
{
    ...
    public class ManagerCompanyWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ManagerCompanyWebFrontEndModule(IWebHostEnvironment env, ManagerCompanyEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ManagerCompanyWebFrontEndModule).GetAssembly());
        }
    }
}
