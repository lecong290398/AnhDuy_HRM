...
using AnhDuyCompany.ManagerCompany.Notifications.Dto;
using Shouldly;
using Xunit;

namespace AnhDuyCompany.ManagerCompany.Tests.Notifications
{
    ...
    public class NotificationAppService_Tests : AppTestBase
    {
        ...
        public async Task Should_CreateMassNotification_Throw_Exception_If_There_Is_No_User()
        {
            await Should.ThrowAsync<UserFriendlyException>(async () =>
            {
                ...
                {
                    TargetNotifiers = new[] { "AnhDuyCompany.ManagerCompany.Notifications.SmsRealTimeNotifier" },
