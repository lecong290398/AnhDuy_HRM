...
using AnhDuyCompany.ManagerCompany.MultiTenancy.HostDashboard;
...
namespace AnhDuyCompany.ManagerCompany.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ManagerCompanyDbContext context, SubscriptionPayment subscriptionPayment)
        {
